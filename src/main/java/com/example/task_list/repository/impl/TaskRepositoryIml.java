...
import com.example.task_list.domain.exception.ResourceMappingException;
...
import com.example.task_list.repository.mappers.TaskRowMapper;
...
public class TaskRepositoryIml implements TaskRepository {
    ...
    public void create(Task task) {
        try {
            ...
            throw new ResourceMappingException("Error while create task.");
        }
    }
